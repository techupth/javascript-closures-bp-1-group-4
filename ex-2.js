...
console.log(addByTwo.addByX(1));
console.log(addByTwo.addByX(2));
console.log(addByTwo.addByX(3));

const subtractByThree = matchAction(3);
console.log(subtractByThree.subtractByX(4));
console.log(subtractByThree.subtractByX(6));
console.log(subtractByThree.subtractByX(8));
